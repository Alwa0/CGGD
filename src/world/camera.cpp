...
theta(0.f), phi(0.f), height(1080.f), width(1920.f),
aspect_ratio(1920.f / 1080.f), angle_of_view(1.04719f), z_near(0.001f),
...
const float4x4 cg::world::camera::get_view_matrix() const
{
	...
	}, { z_axis.x, z_axis.y, z_axis.z, 0 }, { -dot(x_axis, position),
